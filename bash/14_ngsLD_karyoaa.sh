...
#srun -p medium -c 5 --mem=5G --time=7-00:00 -J 05_ngsLD_karyoaa -o 05_ngsLD_per_chr34_karyoaa.log /bin/sh 01_scripts/14_ngsLD_karyoaa.sh CM078251.1 &
...
NIND=$(wc -l 16_het_chr34/aa_geno_bam.filelist)
NCPU=5
...
N_IND=$(wc -l 16_het_chr34/aa_geno_bam.filelist | cut -d " " -f 1)
MIN_IND_FLOAT=$(echo "($N_IND * $PERCENT_IND)"| bc -l)
MIN_IND=${MIN_IND_FLOAT%.*}
MAX_DEPTH=$(echo "($N_IND * $MAX_DEPTH_FACTOR)" |bc -l)

NSITES=$(wc -l 14_ngsld/canonical_CM078251.1_outlier_window.pos)

$NGSLD/ngsLD --geno 14_ngsld/karyo_aa_CM078251.1.beagle.gz \
	--probs \
	--pos 14_ngsld/canonical_CM078251.1_outlier_window.pos  \
	--n_ind "$NIND" \
	--n_sites "$NSITES" \
	--min_maf 0.01 \
	--max_kb_dist 0 \
	--rnd_sample 0.5 \
	--n_threads "$NCPU" \
	--out 14_ngsld/karyoaa_"$REGION".ld 
