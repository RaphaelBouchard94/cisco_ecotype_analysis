...
#srun -p medium -c 5 --mem=5G --time=7-00:00 -J 05_ngsLD_chr34_notsummer -o 05_ngsLD_per_chr34_notsummer.log /bin/sh 01_scripts/14_ngsLD_notsummer.sh CM078251.1 &
...
NIND=$(wc -l 09_pop_bamfile/notsummer_bam.filelist)
NCPU=5
...
N_IND=$(wc -l 09_pop_bamfile/notsummer_bam.filelist | cut -d " " -f 1)
...
$NGSLD/ngsLD --geno 14_ngsld/notsummer_CM078251.1.beagle.gz \
	--probs \
	...
	--rnd_sample 0.5 \
	--n_threads "$NCPU" \
	--out 14_ngsld/notsummer_"$REGION".ld 
