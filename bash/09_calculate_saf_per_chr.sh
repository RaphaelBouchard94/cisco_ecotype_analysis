...
#parallel -a 02_info/regions.txt -j 10 srun -p medium -c 10 --mem=50G --time=12:00:00 -J saf_{} -o saf_{}_%j.log /bin/sh 01_scripts/09_calculate_saf_per_chr.sh notsummer {} &
#parallel -a 02_info/regions.txt -j 10 srun -p medium -c 10 --mem=50G --time=12:00:00 -J saf_{} -o saf_{}_%j.log /bin/sh 01_scripts/09_calculate_saf_per_chr.sh notfall {} &
#parallel -a 02_info/regions.txt -j 10 srun -p medium -c 10 --mem=50G --time=12:00:00 -J saf_{} -o saf_{}_%j.log /bin/sh 01_scripts/09_calculate_saf_per_chr.sh rup {} &
