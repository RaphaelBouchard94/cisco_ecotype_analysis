#!/bin/bash
#srun -p medium -c 10 --mem=50G --time=12:00:00 -J beagle_notsummer_ch34 -o beagle_notsummer_chr34.log /bin/sh 01_scripts/14_get_beagle_notsummer.sh notsummer CM078251.1 &
